...
# 设置日志记录
log_file = './log/test_pca_dim30_epoch150_output.log'  # 日志文件路径
...
def test_model(test_x):
    model = load_model('./model/E-TCN-PCA-DIM30-EPOCH150.h5')  # 加载训练好的模型
...
datas.to_csv('./result/E-TCN-PCA-DIM30-EPOCH150', index=False, header=False)