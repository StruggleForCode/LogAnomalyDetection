...
# 设置日志记录
log_file = './log/test_ppa_dim20_epoch150_output.log'  # 日志文件路径
...
def test_model(test_x):
    model = load_model('./model/E-TCN-PPA-DIM20-EPOCH150.h5')  # 加载训练好的模型
...
print('E-TCN-PPA-DIM20-EPOCH150 ')
# 输出TP, FP, TN, FN值
...
datas.to_csv('./result/E-TCN-PPA-DIM20-EPOCH150', index=False, header=False)