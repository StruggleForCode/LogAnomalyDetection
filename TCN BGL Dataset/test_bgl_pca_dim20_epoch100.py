...
# 设置日志记录
log_file = './log/test_pca_dim20_epoch100_output.log'  # 日志文件路径
...
print('E-TCN-PCA-DIM20-EPOCH100.h5')
# 输出TP, FP, TN, FN值
...
datas.to_csv('./result/E-TCN-PCA-DIM20-EPOCH100', index=False, header=False)