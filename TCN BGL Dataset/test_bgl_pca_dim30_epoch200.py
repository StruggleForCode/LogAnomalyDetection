...
# 设置日志记录
log_file = './log/test_pca_dim30_epoch200_output.log'  # 日志文件路径
...
def test_model(test_x):
    model = load_model('./model/E-TCN-PCA-DIM30-EPOCH200.h5')  # 加载训练好的模型
...
# 输出TP, FP, TN, FN值
print('E-TCN-PCA-DIM30-EPOCH200')
...
datas.to_csv('./result/E-TCN-PCA-DIM30-EPOCH200', index=False, header=False)