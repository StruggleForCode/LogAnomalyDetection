...
# 设置日志记录
log_file = './log/test_pca_dim50_epoch150_output.log'  # 日志文件路径
...
def test_model(test_x):
    model = load_model('./model/E-TCN-PCA-DIM50-EPOCH150.h5')  # 加载训练好的模型
...
# 输出TP, FP, TN, FN值
print('E-TCN-PCA-DIM50-EPOCH150')
...
datas.to_csv('./result/E-TCN-PCA-DIM50-EPOCH150', index=False, header=False)