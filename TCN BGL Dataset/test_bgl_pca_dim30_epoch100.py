...
# 设置日志记录
log_file = './log/test_pca_dim30_epoch100_output.log'  # 日志文件路径
...
def test_model(test_x):
    model = load_model('./model/E-TCN-PCA-DIM30-EPOCH100.h5')  # 加载训练好的模型
...
# 输出TP, FP, TN, FN值
print('E-TCN-PCA-DIM30-EPOCH100')
...
datas.to_csv('./result/E-TCN-PCA-DIM30-EPOCH100', index=False, header=False)